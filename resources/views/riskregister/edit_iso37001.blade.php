    ...
    <div class="container">
        ...
        <form action="{{ route('riskregister.update', $riskregister->id) }}" method="POST">
            ...
            <div class="card p-3 my-3">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label"><strong>Bagian</strong></label>{{-- Pihak yang Berkepentingan --}}
                    <div class="col-sm-10">
                        @php
      ...
      <div class="row mt-2 pihak-custom-row" style="display:none;">
        <div class="col-sm-4">
          <input type="text"
                ...
                <!-- Issue -->
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label mt-1"><strong>Nama Proses </strong></label> {{-- Issue --}}
                    <div class="col-sm-10">
                        ...
                        @foreach ($resikoList as $resiko)
                                ...
                                <div class="mb-3">
                                    <label for="nama_resiko_{{ $resiko->id }}"
                                        class="form-label"><strong>Potensi Risk Penyuapan </strong></label> {{-- Resiko --}}
                                ...
                                <div class="mb-3">
                                    <label for="before_{{ $resiko->id }}"
                                        class="form-label"><strong>Skema Modus Operandi</strong></label>{{--  Before --}}
              ...
              {{--   <div class="row mb-3">
                    ...
                    @foreach ($tindakanList as $tindakan)
                        <div class="action-block" data-id="{{ $tindakan->id }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="acuan[{{ $tindakan->id }}]" class="form-control">
                                        {{ old('acuan.'.$tindakan->id, $tindakan->acuan) }}
                                    </textarea>
                                </div>
                            </div>
                ...
                <br>
                 ...
                 <div class="mb-3" id="after-section">
                    <label for="after_{{ $resiko->id }}"
                        class="form-label"><strong>Rencana Tindakan Mitigasi</strong></label> {{-- After --}}
                    @php
                    ...
                    @if(!$bolehAfter)
                        ...
                        {{-- Pertahankan nilai lama agar tidak hilang saat save --}}
                        <input type="hidden" name="after[{{ $resiko->id }}]" value="{{ $resiko->after }}">
                    @else
