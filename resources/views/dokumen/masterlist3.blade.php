...
@php
  ...
  $hoNames    = [ 'SALES DAN MARKETING','ACCOUNTING','PROCUREMENT','PPIC DAN DELIVERY','EKSPOR DAN IMPOR','TREASURY','INVOICING','BUSSINESS ANALYST','IT'
];
  ...
  $allowByName = function ($divName) use ($hoNames,$commonNames,$upper) {
      $allowed = array_unique(array_merge($upper($hoNames), $upper($commonNames)));
...
<section class="section container-fluid">
   <div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="page-title text-center mb-4">Master List Dokumen – HO</h4>
  ...
  <div class="row g-4 justify-content-center">
    @forelse($divisis as $divisi)
      ...
      <div class="col-auto">
        <a href="{{ route('dok.master.ho.divisi', ['id'=>$divisi->id]) }}" class="text-decoration-none text-dark">
