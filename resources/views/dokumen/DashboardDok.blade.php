            ...
            <div class="row justify-content-center">
                <div class="row justify-content-center">
                    <div class="d-flex flex-wrap gap-3 justify-content-center">
                        <a href="{{ route('dok.master.ckr') }}" class="text-decoration-none">
                            <div class="hover-scale rounded-3 px-3 py-2 " style="background-color: white;">
                                <div class="d-flex flex-row gap-3 align-items-center fs-3" style="color: #4154f1;">
                                    ...
                                    <span style="color: #00286F;">TML-CIKARANG</span>
                                </div>
                            </div>
                        </a>

                        <!-- Card 2 -->
                        <a href="{{ route('dok.master.sdg') }}" class="text-decoration-none">
                            <div class="hover-scale rounded-3 px-3 py-2 " style="background-color: white;">
                                <div class="d-flex flex-row gap-3 align-items-center fs-3" style="color: #4154f1;">
                                    <div class="d-flex justify-content-center align-items-center"
                                        style="width: 50px; height: 50px; border-radius: 50%; background-color: #F6F9FF;">
                                    ...
                                    <span style="color: #00286F;">TML-SADANG</span>
                                </div>
                            </div>
                        </a>
                        <a href="{{ route('dok.master.ho') }}" class="text-decoration-none">
                            <div class="hover-scale rounded-3 px-3 py-2 " style="background-color: white;">
                                <div class="d-flex flex-row gap-3 align-items-center fs-3" style="color: #4154f1;">
                                    <div class="d-flex justify-content-center align-items-center"
                                        style="width: 50px; height: 50px; border-radius: 50%; background-color: #F6F9FF;">
                                    ...
                                    <span style="color: #00286F;">TML-HO</span>
                                </div>
                            </div>
                        </a>
                    </div>
