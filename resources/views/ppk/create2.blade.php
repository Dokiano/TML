                ...
                <div class="px-5 py-3">
                    ...
                    <div class="mb-3">
                        <label for="identifikasi" class="form-label fw-bold">2. Identifikasi, evaluasi & pastikan akar
                            penyebab
                            masalah/Root Cause<span class="text-primary">*</span></label>
                        <textarea placeholder="Kolom berikut harus di isi" name="identifikasi" required
                            class="form-control border border-1 border-primary" id="identifikasi" rows="4">{{ old('identifikasi', $ppk->identifikasi ?? '') }}</textarea>
        ...
        <div class="card shadow-lg border-0">
            <div class="border border-2 border-dark">
                ...
                <div class="px-5 py-3 pb-5">
                    <div class="row mb-3">
                        <div class="col-6"></div>
                        <div class="col fw-md text-secondary">PPK NO. {{ $datalengkap['nomor_surat'] }}</div>
                    </div>
                    <!-- Penanggulangan -->
                    ...
                    <div class="mb-3">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col" class="border border-1 border-dark" style="width: 20%;"></th>
                                    <th scope="col" class="border border-1 border-dark">Tindakan</th>
                                    <th scope="col" class="border border-1 border-dark" style="width: 20%;">Target
                                        Tgl</th>
                                    <th scope="col" class="border border-1 border-dark" style="width: 20%;">PIC</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th scope="row" class="border border-1 border-dark">Penanggulangan</th>
                                    <td class="border border-1 border-dark">
                                        <textarea id="penanggulangan" placeholder="Kolom berikut harus di isi" name="penanggulangan" required
                                            class="form-control border border-1 border-primary" placeholder="" rows="7">{{ old('penanggulangan') }}</textarea>
                                    </td>
                                    <td class="border border-1 border-dark">
                                        <input type="date" name="tgl_penanggulangan" class="form-control" required
                                    ...
                                    <td class="border border-1 border-dark">
                                        <div class="mb-3" id="pic1-dropdown">
                                            ...
                                            <div id="pic1-other" class="pic1other" style="display: none;">
                                                <textarea name="pic1_other" placeholder="Kolom berikut harus di isi" id="pic1_other" class="form-control"
                                                    placeholder="Silahkan masukan PIC diluar option">{{ old('pic1_other', $ppk->pic1_other) }}</textarea>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <th scope="row" class="border border-1 border-dark">Pencegahan</th>
                                    <td class="border border-1 border-dark">
                                        <textarea id="pencegahan" placeholder="Kolom berikut harus di isi" name="pencegahan"
                                            class="form-control border border-1 border-primary" placeholder="" required rows="7">{{ old('pencegahan') }}</textarea>
                                    </td>
                                    <td class="border border-1 border-dark">
                                        <input type="date" name="tgl_pencegahan" class="form-control" required
                    ...
                    <div class="row mb-3">
                        <label for="signaturepenerima" class="col-sm-2 col-form-label fw-bold">Tanda Tangan Penerima*
                            (Pilih
                            Opsi)</label>
                        <div class="col-sm-10">
                            <!-- Pilihan Opsi -->
                                ...
                                <div class="form-check mb-2">
                                    <div class="col-sm-10">
                                        <input class="form-check-input" type="radio" name="signature_option"
                                            id="option1" required value="1" checked>
                            ...
                            <div id="option1-container" class="mb-3 border p-3 rounded"
