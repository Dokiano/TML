...
class KirimEmail2 extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this
            ->from('ppktatametal@gmail.com', 'Status PPK') // Menentukan pengirim email
            ->subject($this->data_email['subject']) // Subjek email
            ->view('mail.kirimemail2', ['data' => $this->data_email]); // View untuk email
    }
}
